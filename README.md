...
## Project Overview
StudyFlow is a responsive landing page for a mock study productivity tool. Built as **Task 1** for the BuildLabs Development Track Internship, this project demonstrates modern frontend development skills including responsive design, CSS Grid/Flexbox, media queries, and interactive UI elements.
...
4. **No Frameworks:** Pure HTML/CSS/JS to demonstrate fundamental skills without dependencies
